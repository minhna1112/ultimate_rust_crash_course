...
fn main() {
    ...
    //
    types_operation::print_difference(coords.0, coords.1);   // Uncomment and finish this line
    ...
    types_operation::print_array(coords_arr);        // and pass it in here (this line doesn't need to change)
    ...
    //
    types_operation::on_off(mess.2[1].0 );
    ...
    types_operation::print_distance(coords);
}
